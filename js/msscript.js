        ...
        success: function(result) {
            for(var i in result ) {
                ...
                $(".repository-thumbs").append(
                    "<div class='repo-single-thumb'><div class='triangle " + get_random_class() + "' style='border-right: 68px solid " + get_random_color() + ";'></div><h2><a href='" + result[i].html_url + "' target='_blank' style='" + $length + ";'>" +
